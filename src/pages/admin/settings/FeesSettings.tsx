...
export function FeesSettings({ fees, setFees, pricing, setPricing, activeLang, setActiveLang }: FeesSettingsProps) {
    return (
        <div className="bg-white dark:bg-neutral-800 rounded-3xl p-8 shadow-sm border border-neutral-100 dark:border-neutral-700 space-y-8 animate-in fade-in slide-in-from-left-2 duration-300">
            <div className="border-b border-neutral-50 dark:border-neutral-700 pb-4">
                ...
                <p className="text-xs text-neutral-500 mt-1">Configura la informació bancària i els preus de les activitats.</p>
            </div>

            {/* Bank Details */}
            <div className="space-y-4">
                <h4 className="text-sm font-bold text-neutral-700 dark:text-neutral-300 uppercase tracking-wide">Dades Bancàries</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-neutral-500">IBAN</label>
                        <input
                            type="text"
                            value={fees.iban}
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-neutral-500">Quota Anual (€)</label>
                        <input
                            type="number"
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-neutral-500">Entitat Bancària</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-neutral-500">Titular del Compte</label>
                        <input
                            type="text"
                ...
                <div className="space-y-1">
                    <label className="text-xs font-bold text-neutral-500">Plantilla Concepte Transferència</label>
                    <input
                        type="text"
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h4 className="text-sm font-bold text-neutral-700 dark:text-neutral-300 uppercase tracking-wide">Preus Activitats</h4>
                        <p className="text-xs text-neutral-400 mt-0.5">Configura els preus per soci / no-soci de cada tipus d'activitat.</p>
                    </div>
                ...
                <div className="space-y-4">
                    {pricing.tiers.map((tier, idx) => (
                        <div key={tier.id} className="p-5 bg-neutral-50 dark:bg-neutral-900 rounded-lg border border-neutral-100 dark:border-neutral-700 space-y-4">
                            <div className="flex items-center justify-between">
                                <input
                                    type="text"
                                    ...
                                    className="font-bold text-sm bg-transparent border-b border-dashed border-neutral-300 dark:border-neutral-600 outline-none pb-1 flex-1 mr-4"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                                ...
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold text-neutral-400 uppercase">Horari</label>
                                    <input
                                        type="text"
                                        value={tier.schedule}
                                        onChange={(e) => {
                                ...
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold text-neutral-400 uppercase">Nota ({activeLang.toUpperCase()})</label>
                                    <input
                                        type="text"
