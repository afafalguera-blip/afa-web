        ...
        <div className="bg-white dark:bg-neutral-800 rounded-3xl p-8 shadow-sm border border-neutral-100 dark:border-neutral-700 space-y-6 animate-in fade-in slide-in-from-left-2 duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300">Email Oficial</label>
                ...
                <div className="space-y-2">
                    <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300">Telèfon (Opcional)</label>
                    <div className="relative">
                ...
                <div className="md:col-span-2 space-y-2">
                    <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300">Direcció Física</label>
                    <div className="relative">
                ...
                <div className="space-y-2">
                    <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300">Horari d'Atenció</label>
                    <div className="relative">
                ...
                <div className="md:col-span-2 space-y-2">
                    <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300">Informació adicional horari / localització</label>
                    <textarea
                        value={contact.schedule_info}
                        onChange={(e) => setContact({ ...contact, schedule_info: e.target.value })}
                        rows={2}
                        className="w-full px-4 py-3 rounded-lg border border-neutral-200 dark:border-neutral-600 bg-neutral-50 dark:bg-neutral-900 focus:ring-2 focus:ring-primary outline-none transition-all"
                    />
                </div>
            </div>
        </div>
