        ...
        <div className="space-y-2">
            ...
            <div className="flex gap-2">
                ...
                <button
                    ...
                    disabled={uploading}
                    className="px-4 py-2 bg-neutral-900 hover:bg-neutral-800 text-white rounded-lg text-xs font-medium transition-colors flex items-center gap-1.5 disabled:opacity-50 shrink-0"
                >
