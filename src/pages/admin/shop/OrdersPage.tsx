...
import { CheckCircle, XCircle, Euro, Truck, Trash2 } from 'lucide-react';
                        ...
                        <div key={order.id} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                                ...
                                <button
                                    ...
                                    className="flex flex-col items-center justify-center p-3 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-100 dark:border-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/20 hover:text-red-600 transition-all text-red-400 min-w-[60px]"
                                    title="Eliminar comanda"
                                >
                                    <Trash2 className="w-5 h-5" />
                                    <span className="text-[10px] font-bold uppercase tracking-widest mt-1">Borrar</span>
                                </button>
