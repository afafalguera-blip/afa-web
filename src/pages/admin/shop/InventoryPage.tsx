...
import { Search, Edit, Plus, Package, Info, AlertTriangle } from 'lucide-react';
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 p-6 bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-2xl">
        <div className="flex items-center gap-2 text-sm text-blue-700 dark:text-blue-400">
          ...
          <span>Els preus es modifiquen editant el producte. L'estoc es pot actualitzar directament al quadre.</span>
        </div>
      </div>
