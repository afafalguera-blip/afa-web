                        ...
                        {!activeDef.selfManaged && (
                            <div className="flex gap-4 items-center pt-2">
                                <button
                                    disabled={saving}
                                    type="submit"
                                    className="flex-1 bg-admin-accent hover:bg-admin-accent-hover text-white font-medium py-3 rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
                                >
                                    {saving ? (
