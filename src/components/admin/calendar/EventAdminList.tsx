        ...
        <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-800 overflow-hidden">
            <div className="p-4 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/50">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg focus:ring-2 focus:ring-primary outline-none transition-all text-neutral-900 dark:text-white"
                        value={searchText}
            ...
            {loading ? (
                ...
                <div className="p-12 text-center text-neutral-500">
                    <Calendar className="w-12 h-12 mx-auto mb-4 text-neutral-200 dark:text-neutral-800" />
                    <p className="font-medium">{t('admin.calendar.no_events')}</p>
                </div>
            ) : (
                <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
                    {filteredEvents.map(event => (
                        <div key={event.id} className="p-4 hover:bg-neutral-50 dark:hover:bg-neutral-800/30 transition-all group">
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap items-center gap-4 mt-1.5 text-xs font-medium text-neutral-500 dark:text-neutral-400">
                                        ...
                                        {event.description && (
                                            <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-400 line-clamp-2 italic">
                                                {event.description}
                                            </p>
                                        )}
                                    </div>
                                ...
                                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        ...
                                        className="p-2 text-primary hover:bg-primary/10 rounded-lg transition-all translate-x-2 group-hover:translate-x-0"
                                    >
                                        <Edit className="w-4 h-4" />
                                    </button>
                                    <button
                                        onClick={() => onDelete(event.id)}
                                        className="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-lg transition-all translate-x-2 group-hover:translate-x-0"
                                    >
