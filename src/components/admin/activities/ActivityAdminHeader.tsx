...
export function ActivityAdminHeader({ onCreate }: ActivityAdminHeaderProps) {
    ...
    return (
        <div className="flex justify-between items-center mb-8">
            ...
            <button
                onClick={onCreate}
                className="bg-primary hover:bg-primary/90 text-white px-5 py-2.5 rounded-lg font-bold shadow-sm shadow-primary/30 flex items-center gap-2 transition-all"
            >
