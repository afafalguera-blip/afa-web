            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="relative md:col-span-1">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-transparent border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-primary outline-none text-neutral-900 dark:text-white"
                        value={value}
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className="w-full px-3 py-2 bg-transparent border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-primary outline-none text-neutral-900 dark:text-white"
                        value={dateFrom}
